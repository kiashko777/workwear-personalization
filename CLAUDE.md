...
```
[ ] Phase 1: DB Schema          — tables verified in DB
[ ] Phase 2: REST Upload        — tested with curl
[ ] Phase 3: GraphQL            — tested in GraphiQL
[ ] Phase 4: Total Collector    — fee appears in cart
[ ] Phase 5: Quote→Order        — data in order admin view
[ ] Phase 6: Admin Grid         — approval workflow working
[ ] Phase 7: Email              — email received in Mailpit
```
